...
var janela01 = document.getElementById("minhajan01");
var img01 = document.getElementById("01");
var ji01 = document.getElementById("j01");
img01.onclick = function(){
  janela01.style.display = "block";
  ji01.src = this.src;
}
var span = document.getElementsByClassName("close")[0];
span.onclick = function() {
  janela01.style.display = "none";
}

var janela02 = document.getElementById("minhajan02");
var img02 = document.getElementById("02");
var ji02 = document.getElementById("j02");
img02.onclick = function(){
  janela02.style.display = "block";
  ji02.src = this.src;
}
var span = document.getElementsByClassName("close")[1];
span.onclick = function() {
  janela02.style.display = "none";
}

var janela03 = document.getElementById("minhajan03");
var img03 = document.getElementById("03");
var ji03 = document.getElementById("j03");
img03.onclick = function(){
  janela03.style.display = "block";
  ji03.src = this.src;
}
var span = document.getElementsByClassName("close")[2];
span.onclick = function() {
  janela03.style.display = "none";
}

var janela04 = document.getElementById("minhajan04");
var img04 = document.getElementById("04");
var ji04 = document.getElementById("j04");
img04.onclick = function(){
  janela04.style.display = "block";
  ji04.src = this.src;
}
var span = document.getElementsByClassName("close")[3];
span.onclick = function() {
  janela04.style.display = "none";
}

var janela05 = document.getElementById("minhajan05");
var img05 = document.getElementById("05");
var ji05 = document.getElementById("j05");
img05.onclick = function(){
  janela05.style.display = "block";
  ji05.src = this.src;
}
var span = document.getElementsByClassName("close")[4];
span.onclick = function() {
  janela05.style.display = "none";
}

var janela06 = document.getElementById("minhajan06");
var img06 = document.getElementById("06");
var ji06 = document.getElementById("j06");
img06.onclick = function(){
  janela06.style.display = "block";
  ji06.src = this.src;
}
var span = document.getElementsByClassName("close")[5];
span.onclick = function() {
  janela06.style.display = "none";
}

var janela07 = document.getElementById("minhajan07");
var img07 = document.getElementById("07");
var ji07 = document.getElementById("j07");
img07.onclick = function(){
  janela07.style.display = "block";
  ji07.src = this.src;
}
var span = document.getElementsByClassName("close")[6];
span.onclick = function() {
  janela07.style.display = "none";
}

var janela08 = document.getElementById("minhajan08");
var img08 = document.getElementById("08");
var ji08 = document.getElementById("j08");
img08.onclick = function(){
  janela08.style.display = "block";
  ji08.src = this.src;
}
var span = document.getElementsByClassName("close")[7];
span.onclick = function() {
  janela08.style.display = "none";
}

var janela09 = document.getElementById("minhajan09");
var img09 = document.getElementById("09");
var ji09 = document.getElementById("j09");
img09.onclick = function(){
  janela09.style.display = "block";
  ji09.src = this.src;
}
var span = document.getElementsByClassName("close")[8];
span.onclick = function() {
  janela09.style.display = "none";
}

var janela10 = document.getElementById("minhajan10");
var img10 = document.getElementById("10");
var ji10 = document.getElementById("j10");
img10.onclick = function(){
  janela10.style.display = "block";
  ji10.src = this.src;
}
...
var janela11 = document.getElementById("minhajan11");
var img11 = document.getElementById("11");
var ji11 = document.getElementById("j11");
img11.onclick = function(){
  janela11.style.display = "block";
  ji11.src = this.src;
}
...
var janela12 = document.getElementById("minhajan12");
var img12 = document.getElementById("12");
var ji12 = document.getElementById("j12");
img12.onclick = function(){
  janela12.style.display = "block";
  ji12.src = this.src;
}
